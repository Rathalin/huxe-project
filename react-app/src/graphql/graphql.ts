...
export type MoodPriorityEntity = {
  __typename?: 'MoodPriorityEntity';
  attributes?: Maybe<MoodPriority>;
  id?: Maybe<Scalars['ID']>;
};

export type MoodPriorityEntityResponse = {
  __typename?: 'MoodPriorityEntityResponse';
  data?: Maybe<MoodPriorityEntity>;
};

export type MoodPriorityEntityResponseCollection = {
  __typename?: 'MoodPriorityEntityResponseCollection';
  data: Array<MoodPriorityEntity>;
  meta: ResponseCollectionMeta;
};
...
export type MoodPriorityFiltersInput = {
  ...
  createdAt?: InputMaybe<DateTimeFilterInput>;
  id?: InputMaybe<IdFilterInput>;
  not?: InputMaybe<MoodPriorityFiltersInput>;
  or?: InputMaybe<Array<InputMaybe<MoodPriorityFiltersInput>>>;
...
export type MutationUpdateMoodPriorityArgs = {
  data: MoodPriorityInput;
  id: Scalars['ID'];
};
...
export type QueryMoodPrioritiesArgs = {
  filters?: InputMaybe<MoodPriorityFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  publicationState?: InputMaybe<PublicationState>;
  sort?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
};
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'UsersPermissionsLoginPayload', jwt?: string | null, user: { __typename?: 'UsersPermissionsMe', username: string } } };
